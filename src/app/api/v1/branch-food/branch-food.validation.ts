...
export class BranchFoodValidationService {
    private readonly createFoodSchema = z.object({
      ...
      async validateCreateFoodInput(input: CreateBranchFoodInput) {
        // basic validation
      ...
      private validateVariants(variants: CreateBranchFoodInput["variants"]) {
