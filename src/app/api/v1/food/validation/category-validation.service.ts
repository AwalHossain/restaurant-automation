...
export class CategoryValidationService {
    ...
    private readonly baseCategorySchema = {
        name: z.string()
    ...
    private readonly createCategorySchema = z.object({
    ...
    private readonly addSubCategorySchema = z.object({
    ...
    private readonly updateCategorySchema = z.object({
    ...
    async validateCreateCategory(input: any) {
        try {
            const validatedData = this.createCategorySchema.parse(input);
    ...
    async validateAddSubCategory(input: any) {
        try {
            const validatedData = this.addSubCategorySchema.parse(input);
    ...
    async validateUpdateCategory(input: any) {
        try {
            const validatedData = this.updateCategorySchema.parse(input);
